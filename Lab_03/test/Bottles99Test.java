...
public class Bottles99Test
{
    ...
    @Test
    public void singleVerseTest()
    {
        Bottles99 b99 = new Bottles99();

        String expected = "44 bottles of beer on the wall, 44 bottles of beer.\n" +
                "Take one down and pass it around, 43 bottles of beer on the wall.";

        assertEquals(expected, b99.singleVerse(44));

    }


    @Test
    public void rangedVersesTest()
    {
        Bottles99 b99 = new Bottles99();
        ...
        assertEquals(expected, b99.rangedVerses(8, 4));
    }


    @Test
    public void fullSongTest()
    {
        Bottles99 b99 = new Bottles99();
        ...
        assertEquals(expected, b99.rangedVerses(99, 0));

    }


    @Test
    public void wrongNumberOfLines()
    {
        String expected = "WRONG";

        Bottles99 b99 = new Bottles99();

        assertEquals(expected, b99.singleVerse(150) );
    }
